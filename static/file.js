    ...
    function upload(files) {
        ...
        for (let i = 0; i < files.length; i++) {
            ...
            if(ext !='.PNG' && ext !='.GIF' && ext !='.JPG' && ext !='.JPEG' && ext !='.BMP'){  
 	        ...
 	        var type = $('#type').val();
  	        if(type =='qihoo'|type =='muke'|type =='gtimg'|type =='catbox'|type =='vxichina'){var api = 'https://www.hualigs.cn/api/upload?token=8ff730a4dc52360c26854111c794742b&apiType=';}else if(type =='imgbb'){var api = 'https://api.imgbb.com/1/upload?key=f550a1912f29046b64b3272fe6be11df&type=';}else{var api = 'https://image.kieng.cn/upload.html?type='};
